...
**Note**: _This template uses poetry for dependency management. 
This repository is a template for data science  and machine learning projects. This is the project structure recommended for use to ensure reproducible models across various teams. 
...
```bash
cookiecutter https://github.com/Application-Management-Division/GDP_DS-ML_Template
```
